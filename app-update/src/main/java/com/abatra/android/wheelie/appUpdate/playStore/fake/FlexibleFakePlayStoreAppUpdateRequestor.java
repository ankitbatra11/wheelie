...
import com.abatra.android.wheelie.core.async.AndroidThread;
import com.abatra.android.wheelie.core.async.HandlerAndroidThread;
...
public class FlexibleFakePlayStoreAppUpdateRequestor extends FakePlayStoreAppUpdateRequestor {
    ...
    protected void startAppUpdateFlowOrThrow(PlayStoreAppUpdateRequest storeAppUpdateRequest) {
        ...
        Preconditions.checkState(getFakeAppUpdateManager().isConfirmationDialogVisible());
